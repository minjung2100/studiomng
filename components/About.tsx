  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative z-10 px-8 md:px-16 pt-24 md:pt-0 pb-16 md:pb-0 flex flex-wrap md:flex-nowrap items-start md:items-center justify-between gap-8">
          <h1 className="text-[18vw] md:text-[13vw] font-black leading-[0.85] uppercase text-black w-full md:w-auto shrink-0">
            studio
            <br />
            mng.
          </h1>
